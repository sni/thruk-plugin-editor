ace.define("ace/mode/nagios_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/text_highlight_rules"], function(require, exports, module) {
"use strict";
...
var NagiosHighlightRules = function() {
...
oop.inherits(NagiosHighlightRules, TextHighlightRules);
exports.NagiosHighlightRules = NagiosHighlightRules;
});
...
ace.define("ace/mode/nagios_completions",["require","exports","module"], function(require, exports, module) {
"use strict";

var NagiosCompletions = function() {};
(function() {
    var highlight_rules = require("./nagios_highlight_rules");
...
}).call(NagiosCompletions.prototype);
exports.NagiosCompletions = NagiosCompletions;
});


ace.define("ace/mode/nagios",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/nagios_highlight_rules","ace/mode/matching_brace_outdent","ace/mode/nagios_completions","ace/mode/behaviour/nagios","ace/mode/folding/cstyle"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var TextMode = require("./text").Mode;
var NagiosHighlightRules = require("./nagios_highlight_rules").NagiosHighlightRules;
var MatchingBraceOutdent = require("./matching_brace_outdent").MatchingBraceOutdent;
var NagiosCompletions = require("./nagios_completions").NagiosCompletions;
var CStyleFoldMode = require("./folding/cstyle").FoldMode;

var Mode = function() {
    this.HighlightRules = NagiosHighlightRules;
    this.$outdent = new MatchingBraceOutdent();
    this.foldingRules = new CStyleFoldMode();
    this.$completer = new NagiosCompletions();
};
